...
use backend\models\FundsRecord;
...
class TaskTemplateForm extends \common\models\TaskTemplateForm
{
    ...
    public function rules()
    {
        ...
        $rules[] = ['username', 'validateExit'];
        return $rules;
    }

    public function attributeLabels()
    {
        $attributeLabels = parent::attributeLabels(); // TODO: Change the autogenerated stub
        $attributeLabels['username'] = Yii::t('app', '用户名');
     ...
     * @return bool
     */
    public function validateExit($attribute, $params)
    {
    ...
    public function save()
    {
        ...
        try {
            ...
            $noticeModel->content = "<a href='" . Yii::$app->urlManager->createAbsoluteUrl(['job/view', 'id'=>$jobModel->job_id]) . "' >请点击链接审核</a>";
            if (!$noticeModel->save()) {
                $this->addError('table', self::FAILURE_CREATE_JOB_MSG);
